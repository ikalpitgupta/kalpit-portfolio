...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-white dark:from-gray-900 dark:to-gray-800 pt-16">
      <div className="container-max section-padding text-center">
        <div className="animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-poppins">
            <span className="text-gray-900 dark:text-white">KALPIT</span>
            <br />
            <span className="text-gradient">GUPTA</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            Aspiring Software Engineer | Full Stack Developer | Cloud & AI Enthusiast
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
            <div className="flex items-center space-x-2 text-gray-700 dark:text-gray-300">
              ...
              <span>kalpitg1203@gmail.com</span>
            </div>
